 ...
 * 
 * v1.2, 28.035.2020       Автор: Труфанов В.Е. 
...
var e_iama=false;   // нажата любая клавиша (true - отпущена 'стрелка вниз')
...
// Обрабатываем отпускание клавиши 'стрелка вниз'
// Обрабатываем отпускание неправильной клавиши
...
// Обрабатываем нажатие любой клавиши кроме 'стрелка вниз'
